...
class Course(models.Model):
    cource_org = models.ForeignKey(CourseOrg,verbose_name=u'课程机构',null=True,blank=True)
    name = models.CharField(max_length=50,verbose_name=u'课程名')
    desc = models.CharField(max_length=300,verbose_name=u'课程描述')
    detail = models.TextField(verbose_name=u'课程详情')
    need_know = models.CharField(default="",verbose_name="课程须知",max_length=100)
    teacher_tell = models.CharField(default="",verbose_name="课程得到",max_length=100)
